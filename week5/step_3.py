...
# Brad Voris
# 9/28/2022
# week 5 Programming Assignment Step 3
...
while True:
    ...
    if selection == "0":        
        ...
        print(f'Your selection was: {selection}')
        word = input("Please input a word to be converted: ")
...
# Input validation in this is pretty difficult        
        try:
            ...
            print()
            print(f'Your selection was "{morsecode}", the Morse value is ', translate_to_alpha())
        input()
    else:
